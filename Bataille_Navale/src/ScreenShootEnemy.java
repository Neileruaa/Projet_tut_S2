...
public class ScreenShootEnemy extends ScreenShoot {
    ...
    public void render(GameContainer gameContainer, StateBasedGame stateBasedGame, Graphics graphics) throws SlickException {
        if(!EcranTirDejaCharge){
            plateauEcranTir = saverReader.readEcranTir(2);
        ...
        graphics.drawImage(passe,1200,810);
        ...
        //save ecranTir
        saverReader.saveEcranTir(2, plateauEcranTir);
...
//            jouerSon("res/Musique/explosion.wav");
    ...
    public void passerTour(StateBasedGame stateBasedGame , int i) {
        ...
        int posY = Mouse.getY();
        timer -= i;
        if (dejaTire && (posX > 1200 && posX < 1290) && (posY > 0 && posY < 100) || timer<=0) {

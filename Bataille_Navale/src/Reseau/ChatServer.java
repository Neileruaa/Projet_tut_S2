...
public class ChatServer {
    ...
    public ChatServer () throws IOException {
        ...
        server.addListener(new Listener() {
            public void received (Connection c, Object object) {
                ...
                if (object instanceof Network.ChatMessage) {
                    System.out.println("Je suis passé dans chat server");
                ...
                if (object instanceof Network.gameParameter){
                    ...
                    String nom = gameParameter.playerName;
                    String age = gameParameter.playerAge;
                    int nbBateau = gameParameter.shipNumber;
                    ...
                    //TESTS A APPLIQUE AU NB DE BATEAU

                    gameParameter.shipNumber = nbBateau;

                    server.sendToAllTCP(gameParameter);
                    return;
                }
            }
        ...
        frame.getContentPane().add(new JLabel("Fermer cette fenêtre pour arreter le server"));
